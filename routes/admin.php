...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'auth:admin'], function(){
    ...
    Route::get('posts', 'DashboardController@post')->name('admin.posts');
    Route::get('addMember', 'MemberController@addMember')->name('admin.add.member');
    Route::get('logout', 'LoginController@logout')->name('admin.logout');
    Route::post('insertMember', 'MemberController@insertMember')->name('admin.insert.member');
    Route::get('editMembers/{id}', 'MemberController@editMember')->name('admin.edit.member');
    Route::get('editPost/{id}', 'PostController@editPost')->name('admin.edit.post');
